...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class ScalerOneGrabTranslateTransformer : MonoBehaviour, ITransformer
    {
        [Serializable]
        ...
        [SerializeField] private UnityEvent beginTransformEvent;
        [SerializeField] private UnityEvent endTransformEvent;
