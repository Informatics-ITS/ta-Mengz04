...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class CustomGrabFreeTransformer : MonoBehaviour, ITransformer
    {
        [SerializeField]
        ...
        [SerializeField] private UnityEvent onBeginTransform;
        [SerializeField] private UnityEvent onEndTransform;
