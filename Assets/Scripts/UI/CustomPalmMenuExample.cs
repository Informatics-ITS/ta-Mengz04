...
namespace Oculus.Interaction.Samples.PalmMenu
{
    ...
    /// </summary>
    public class CustomPalmMenuExample : MonoBehaviour
    {
        [SerializeField]
        ...
        [SerializeField]
        private GameObject[] _targetSubmenus;
        ...
        {
            return _currentSelectedButtonIdx;
        }
        ...
        private void Start()
        {
			...
			_targetSubmenus[_currentSelectedButtonIdx].SetActive(true);
		}
        ...
        {
            foreach (GameObject submenu in _targetSubmenus)
            {
