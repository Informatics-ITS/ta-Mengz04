...
namespace Leap
{
    public class TrackingMarkerObjectModified : MonoBehaviour
    {
...
//         private void Update()
//         {
//             trackedObject.localPosition = targetPos;
//             trackedObject.localRotation = targetRot;
//         }
...
//         {
//             // Debug.Log("Raw vec3: " + trackedMarkerPosition);
